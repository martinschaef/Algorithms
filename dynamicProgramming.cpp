...
void test_inputs() {
    cout << "expected distance 0" << endl;
    run("SSASTVVSAA", "SSASTVVSAA"); //equals

    cout << "expected distance 1" << endl; //left side letter changed
    run("GSASTVVSAA", "SSASTVVSAA");

    cout << "expected distance 2" << endl; //left side shorter
    run("SSASVVSAA", "SSASTVVSAA");

    cout << "expected distance 2" << endl; //right side shorter
    run("SSASTVVSAA", "SSASVVSAA");

    cout << "expected distance 2" << endl;
    run("SASTVVSAA", "SSASTVVSAA"); //left first missing

    cout << "expected distance 2" << endl;
    run("SSASTVVSAA", "SASTVVSAA"); //right first missing

    cout << "expected distance 6" << endl;
    run("SSASTVVSAA", "SSASTVV"); //last 3 missing right

    cout << "expected distance 6" << endl;
    run("SSASTVV", "SSASTVVSAA"); //last 3 missing left

    cout << "expected distance 6" << endl;
    run("ABC", ""); //comparison with empty string
}
